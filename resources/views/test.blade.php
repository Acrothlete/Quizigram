	...
	<div class="row">
		...
		<div class="form_container my-4">
            ...
            <table class="table text-center table-striped">
                <thead class="green_table_header">
                  <tr>
                    <th scope="col">Name</th>
                    <th scope="col">Time Limit</th>
                    <th scope="col">Pass Percentage</th>
                    <th scope="col">Start/Stop Test</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row">{{$test->test_name}}</th>
                        <td>{{$test->time_limit}} Minutes</td>
                        <td>{{$test->passing_percentage}} %</td>
                        <td>
                            <div class="custom-control custom-switch">
                            <input onchange="myFunction('link{{$test->id}}')" type="checkbox" class="custom-control-input" id="customSwitch{{$test->id}}">
                                <label class="custom-control-label" for="customSwitch{{$test->id}}"></label>
                              </div>
                              {{-- <button onclick="myFunction('link{{$test->id}}')">Try it</button> --}}

                        </td>
                    <td><a id="link{{$test->id}}" style="display:none" href="http://dummylink.com/test/{{$test->id}}">http://dummylink.com/test/{{$test->id}}</a></td>
                      </tr>
                    @endforeach
...
@else
		<div class="text-center">
            <h4>You have not created any test!!</h4>
            <p>You may create a test by clicking on below button.</p>
            <div class="row">
            {{-- <button type="button" onclick="{{redirect('/create-test')}}"  class="btn btn-primary mx-auto mt-3 green_button">Create Test</button> --}}
            <a href="/admin/create-test" class="btn btn-primary mx-auto mt-3 green_button">Create Test</a>
            </div>
        </div>
@endif
...
<div id="copyright" class="row">
	<p class="mx-auto">&copy; O2h. All rights reserved. | Design by GeekLords</p>
</div>
<script> 
