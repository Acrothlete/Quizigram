            ...
            <div class="form_container my-4">
                ...
                <table class="table text-center table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td scope="row">{{$result->user_data->name}}</td>
                            <td scope="row">{{$result->user_data->email}}</td>
                            <td scope="row">{{$result->user_data->college}}</td>
                            <td scope="row">{{$result->user_data->year_of_graduation}}</td>
                            <td scope="row">{{$result->test_name}}</td>
                            <td scope="row">{{$result->obtained_marks}}/{{$result->total_marks}}</td>
                            <td scope="row">{{$result->obtained_percentage}} %</td>
