<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="college" value="{{ __('College') }}" />
                <x-jet-input id="college" class="block mt-1 w-full" type="text" name="college" :value="old('college')"  required />
            </div>
            
            <div class="mt-4">
                <x-jet-label for="stream" value="{{ __('Stream') }}" />
                <x-jet-input id="stream" class="block mt-1 w-full" type="text" name="stream" :value="old('stream')"  required />
            </div>
            
            <div class="mt-4">
                <x-jet-label for="year_of_graduation" value="{{ __('year_of_graduation') }}" />
                <x-jet-input id="year_of_graduation" class="block mt-1 w-full" type="number" name="year_of_graduation" :value="old('year of graduation')"  required />
            </div>
