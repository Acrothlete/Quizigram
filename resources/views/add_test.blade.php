...
<div class="row">  
	<div id="three-column" class="container">
		<div class="title">
			<div id="create_test">Create Test</div>
		</div>
    </div>
</div>
	<div class="d-flex row form_box">
        <div class="form_container">
            <form class="create_test_form" method="POST" action="{{ url('/admin/create-test') }}">
                    @csrf
            
                <div class="form-group">
                  <label for="test_name">Test Name</label>
                  <input type="text" class="form-control" placeholder="Enter Test name" value="{{ old('test_name') }}" name="test_name" id="test_name">
                ...
                <div class="form-group">
                    <label for="test_limit">Duration</label>
                    <select class="form-control" value="15" name="test_limit" id="test_limit">
                    ...
                    <p>{{ old('test_limit') }}</p>
                    @if ($errors->has('test_limit'))
                    <span class="help-block text-danger">
                        <strong>{{ $errors->first('test_limit') }}</strong>
                    </span>
                @endif
                  </div>
                ...
                <div class="form-group">
                  <label for="passing_percentage">Minimum Passing Percentage</label> 
                  <div class="form-row ml-1">     
                  <input type="number" value="{{ old('passing_percentage') }}"  class="form-control col-sm-2" name="passing_percentage" id="passing_percentage" min="0" max="100">
                    <span class="ml-2 pt-2 col-sm-1">%</span>
                </div>
                ...
                <div class="row">
                    <button type="submit"  class="btn btn-primary mx-auto mt-3 green_button">Create Test</button>
                  </div>
...
<div id="copyright" class="row">
	<p class="text-center">&copy; O2h. All rights reserved. | Design by GeekLords</p>
</div>
